...
namespace SpotifyClone.Entities
{
    public class UserDTO : PersonDTO
    {
        ...
        public UserDTO(string Name, string Surname, string Username, string language, string birthday) : base(Name, Surname, birthday)
        {
        ...
        {
            return $"Username:{UserName} - Is Also an Artist:{IsArtist} - Subscription: Free:{IsFree} Premium:{isPremium} Gold:{IsGold} - Language:{language}";
        }
