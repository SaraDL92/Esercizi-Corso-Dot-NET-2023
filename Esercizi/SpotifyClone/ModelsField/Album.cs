...
namespace SpotifyClone.Entities
{
    public class Album 
    {
        ...
        public Album(string title, string releaseDate, string numbOfTracks, Artist artist, GroupDTO group, bool liveVersion)
            {
                _title = title;
        ...
        {
            return $"{Title},{Artist.ArtistName},{ReleaseDate},{NumbOfTracks},{Group},{LiveVersion}";
        }
